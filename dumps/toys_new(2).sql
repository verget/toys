...
--
-- Хост: localhost
-- Время создания: Фев 03 2015 г., 10:10
...
('21347d1705d24a750661ed6120f3accf', '127.0.0.1', 'Mozilla/5.0 (X11; Ubuntu; Linux x86_64; rv:35.0) Gecko/20100101 Firefox/35.0', 1422015365, 'a:2:{s:9:"user_data";s:0:"";s:4:"user";a:3:{s:8:"username";s:5:"admin";s:9:"logged_in";b:1;s:4:"role";s:1:"1";}}');
...
(2, 1, 1, 2, ' Матрешка обыкновенная', '', 'шт.', '5', '5', '4242424242421444444', '', '<p>Матрешка матрешечная, очень красивая, Китай нрукриукикцпк3пукм екпкупрвпикуи укпукикупкп купукпукп куекпукпукпк упукпкуп</p>', 390, 0, '', ''),
(21, 2, 3, 1, 'Велосипед спортивный', '111', 'шт.', '0', '0', '0', NULL, NULL, 100, 0, NULL, NULL);
...
(14, 2, '2_3719733d25a139661e3241e3b39d52b5.jpg');
...
(4, 'Новогодний стол для самых маленьких', '23.01.2015', '<p>Если в Вашем доме в канун новогодней ночи соберется много детишек, организуйте для них отдельный стол. Не обязательно украшать его шишками, сосновыми веточками и ёлочными игрушками. Ребята придут в восторг от разноцветных воздушных или фольгированных шаров в виде любимых мультипликационных героев, ярких надписей-растяжек на всю стену, посуды с изображением сказочных персонажей.</p>', 'Новый год, СЛВ, игрушки', 'Новый год, СЛВ, игрушки', '2015-01-23 16:15:36'),
(5, 'Минимальный заказ.', '14 Января, 13:45', '<p>Уважаемые покупатели! Обращаем Ваше внимание на то, что <span style="text-decoration: underline;">минимальный заказ в нашем магазине 1 - упаковка</span>.. Всегда рады Вам в нашем магазине!&nbsp;</p>', 'Игрушки, СЛВ, Краснодар', 'Игрушки, СЛВ, Краснодар', '2015-01-23 16:16:02');
...
INSERT INTO `orders` (`id`, `client_name`, `client_address`, `items`) VALUES
(1, 'fff', 'fff', '2,21,21,2,21'),
(2, 'fghfh', 'fhfhf', '2,21,21,2,21'),
(3, 'Sfdsfsdf', 'zdfsfsf', '21,2'),
(4, 'dfdf', 'dfdfd', '21,2'),
(5, 'SDfsdfs', 'sdfsfs', '21,2'),
(6, 'ghjgj', 'gjgj', '21,2'),
(7, 'SDFsdf', 'Dds', '21,2');
...
(8, 'cart', 'Корзина', 'Корзина', 'Корзина', '');
